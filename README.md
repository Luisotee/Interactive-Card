...
I do not plan on fixing this as the program was built with a goal on learning how to use react and mantine, and not troubleshooting deep problems inside the mantine framework. 
